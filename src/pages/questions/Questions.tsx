...
import { quizDataType, quizOption, quizSingleDataType } from "types";
...
export const Questions = () => {
  ...
  const selectedQuiz =  quizData.find(function (el) {
    return el?._id === Number(quizId);
  })
  ...
  return (
    <main className="quiz-container">
      <div className="card-vertical ques theme-color">
        <h2 className="justify-center">{selectedQuiz?.heading}</h2>
        ...
        <div className="ques-and-ans mt-2">
          ...
          <div className="option-wrapper mb-2">
            {options?.map((el:quizOption, index:number) => {
              return (
                <div
                  key={index}
                  onClick={() => {
