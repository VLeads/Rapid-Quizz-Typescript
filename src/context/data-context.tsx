...
import { quizAction, quizContextType, quizReducerState, reactChildren } from "types";
import { actionConstants } from "./actionConstants";

const QuizContext = createContext({} as quizContextType);

const QuizDataProvider = ({ children } : reactChildren) => {
  const [quizState, quizDispatch] = useReducer(
    function quizReducer(state:quizReducerState, action:quizAction) {
